...
public class hikimodori1 extends HttpServlet {
    ...
    String[] profile(String id){
        String[] pro1 = {"460","桜","1999/10/25","geekjob"};
        String[] pro2 = {"222","凛","1980/11/15","camp"};
        String[] pro3 = {"530","蘭","2002/04/08","yami"};
        String[] pro4 = {"そのIDは存在しません"};
        //==演算子　Stringオブジェクトが保持している参照を比較
        //equalsメソッド　Stringオブジェクトが管理している文字列を比較
        if(id.equals(pro1[0])){return pro1;}
        else if(id.equals(pro2[0])){return pro2;}
        else if(id.equals(pro3[0])){return pro3;}
        else{return pro4;}
